...
class Feed extends Component {
  ...
  finishEditHandler = postData => {
    ...
    fetch('https://rest-api-proj.herokuapp.com/post-image', {
      method: 'PUT',
      headers: {
        Authorization: "Bearer " + this.props.token
      },
      ...
      .then(fileResData => {
        ...
        return fetch('https://rest-api-proj.herokuapp.com/graphql', {
          method: 'POST',
          body: JSON.stringify(graphqlQuery),
          headers: {
            Authorization: "Bearer " + this.props.token,
  ...
  deletePostHandler = postId => {
    ...
    fetch('https://rest-api-proj.herokuapp.com/graphql', {
      ...
      .then(resData => {
        if (resData.errors) {
          console.log(resData.errors[0])
          throw new Error('Post deletioon failed');
        }
        console.log(resData);
        this.loadPosts();
        /* this.setState(prevState => {
